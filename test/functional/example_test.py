...
def custom_function():
    ...
    # self.log.info("running custom_function")  # Oops! Can't run self.log outside the FinalcoinTestFramework
    pass


class ExampleTest(FinalcoinTestFramework):
    # Each functional test is a subclass of the FinalcoinTestFramework class.
    ...
    def custom_method(self):
        ...
        FinalcoinTestFramework class so other tests can use it."""
