...
By default, finalcoind will dump mempool on shutdown and
...
class MempoolPersistTest(FinalcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.debug("Prevent finalcoind from writing mempool.dat to disk. Verify that `savemempool` fails")
