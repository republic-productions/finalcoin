...
class TestFinalcoinCli(FinalcoinTestFramework):
    ...
    def run_test(self):
        ...
        self.log.info("Compare responses from getblockchaininfo RPC and `finalcoin-cli getblockchaininfo`")
        ...
        self.log.info("Test -getinfo and finalcoin-cli return all proxies")
        ...
        if self.is_wallet_compiled():
            self.log.info("Test -getinfo and finalcoin-cli getwalletinfo return expected wallet info")
            ...
            # Test finalcoin-cli -generate with -rpcwallet in multiwallet mode.
