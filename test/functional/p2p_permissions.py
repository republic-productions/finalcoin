...
class P2PPermissionsTests(FinalcoinTestFramework):
    ...
    def replaceinconfig(self, nodeid, old, new):
        with open(self.nodes[nodeid].finalcoinconf, encoding="utf8") as f:
            newText = f.read().replace(old, new)
        with open(self.nodes[nodeid].finalcoinconf, 'w', encoding="utf8") as f:
            f.write(newText)
