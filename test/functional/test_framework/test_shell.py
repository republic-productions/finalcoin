...
class TestShell:
    """Wrapper Class for FinalcoinTestFramework.

    The TestShell class extends the FinalcoinTestFramework
    ...
    class __TestShell(FinalcoinTestFramework):
        ...
        def setup(self, **kwargs):
            ...
            # by FinalcoinTestFramework child class.
            self.num_nodes = 1
