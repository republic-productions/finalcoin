...
"""
Test starting finalcoind with -bind and/or -bind=...=onion and confirm
...
class BindExtraTest(FinalcoinTestFramework):
    ...
    def run_test(self):
        for i in range(len(self.expected)):
            ...
            # that finalcoind has bound on "::1" (for RPC) and "::" (for P2P).
