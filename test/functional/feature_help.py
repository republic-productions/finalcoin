...
"""Verify that starting finalcoin with -h works as expected."""

from test_framework.test_framework import FinalcoinTestFramework
from test_framework.util import assert_equal

class HelpTest(FinalcoinTestFramework):
    ...
    def run_test(self):
        self.log.info("Start finalcoin with -h for help text")
        ...
        self.log.info("Start finalcoin with -version for version information")
        ...
        self.log.info("Start finalcoind with -fakearg to make sure it does not start")
