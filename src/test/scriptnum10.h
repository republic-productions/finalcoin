...
#ifndef FINALCOIN_TEST_SCRIPTNUM10_H
#define FINALCOIN_TEST_SCRIPTNUM10_H
...
{
/**
 * The ScriptNum implementation from Finalcoin Core 0.10.0, for cross-comparison.
 */
public:
