...
#ifndef FINALCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
#define FINALCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
...
#endif // FINALCOIN_WALLET_EXTERNAL_SIGNER_SCRIPTPUBKEYMAN_H
