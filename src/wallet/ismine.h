...
#ifndef FINALCOIN_WALLET_ISMINE_H
#define FINALCOIN_WALLET_ISMINE_H
 ...
 * https://github.com/republicproductions/finalcoin/blob/master/doc/release-notes/release-notes-0.21.0.md#ismine-semantics
...
#endif // FINALCOIN_WALLET_ISMINE_H
