...
#ifndef FINALCOIN_WALLET_SCRIPTPUBKEYMAN_H
#define FINALCOIN_WALLET_SCRIPTPUBKEYMAN_H
 ...
 * change.
 *
 * The Finalcoin Core wallet was originally a collection of unrelated private
...
#endif // FINALCOIN_WALLET_SCRIPTPUBKEYMAN_H
