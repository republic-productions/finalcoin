...
#ifndef FINALCOIN_WALLET_WALLETUTIL_H
#define FINALCOIN_WALLET_WALLETUTIL_H
...
enum WalletFlags : uint64_t {
    ...
    //! finalcoin from opening the wallet, thinking it was newly created, and
...
#endif // FINALCOIN_WALLET_WALLETUTIL_H
