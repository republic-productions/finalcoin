...
#ifndef FINALCOIN_WALLET_TRANSACTION_H
#define FINALCOIN_WALLET_TRANSACTION_H
...
public:
     ...
     * on this finalcoin node, and set to 0 for transactions that were created
...
#endif // FINALCOIN_WALLET_TRANSACTION_H
