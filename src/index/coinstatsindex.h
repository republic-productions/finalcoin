// Copyright (c) 2020-2021 The Finalcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef FINALCOIN_INDEX_COINSTATSINDEX_H
#define FINALCOIN_INDEX_COINSTATSINDEX_H
...
#endif // FINALCOIN_INDEX_COINSTATSINDEX_H
