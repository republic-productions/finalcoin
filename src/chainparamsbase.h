...
#ifndef FINALCOIN_CHAINPARAMSBASE_H
#define FINALCOIN_CHAINPARAMSBASE_H
...
/**
 * CBaseChainParams defines the base parameters (shared between finalcoin-cli and finalcoind)
 * of a given instance of the Finalcoin system.
 */
...
#endif // FINALCOIN_CHAINPARAMSBASE_H
