// Copyright (c) 2018-2021 The Finalcoin Core developers
// Distributed under the MIT software license, see the accompanying
// file COPYING or http://www.opensource.org/licenses/mit-license.php.

#ifndef FINALCOIN_EXTERNAL_SIGNER_H
#define FINALCOIN_EXTERNAL_SIGNER_H
...
#endif // FINALCOIN_EXTERNAL_SIGNER_H
