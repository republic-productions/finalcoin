...
#ifndef FINALCOIN_NET_H
#define FINALCOIN_NET_H
 ...
 * src/qt/guiutil.cpp and src/finalcoin-cli.cpp::NetinfoRequestHandler. */
enum class ConnectionType {
     ...
     * Note that in the literature ("Eclipse Attacks on Finalcoin’s Peer-to-Peer Network")
