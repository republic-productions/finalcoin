    ...
    mapper(nullptr)
{
    ...
    ui->finalcoinAtStartup->setVisible(false);
    ui->verticalLayout_Main->removeWidget(ui->finalcoinAtStartup);
    ...
    ui->finalcoinAtStartup->setToolTip(ui->finalcoinAtStartup->toolTip().arg(PACKAGE_NAME));
    ui->finalcoinAtStartup->setText(ui->finalcoinAtStartup->text().arg(PACKAGE_NAME));

    ui->openFinalcoinConfButton->setToolTip(ui->openFinalcoinConfButton->toolTip().arg(PACKAGE_NAME));
    ...
    ui->unit->setModel(new FinalcoinUnits(this));
...
{
    /* Main */
    mapper->addMapping(ui->finalcoinAtStartup, OptionsModel::StartAtStartup);
...
void OptionsDialog::on_openFinalcoinConfButton_clicked()
{
