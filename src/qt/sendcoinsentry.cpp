    ...
    platformStyle(_platformStyle)
{
    ...
    // normal finalcoin address field
    GUIUtil::setupAddressWidget(ui->payTo, this);
    // just a label for displaying finalcoin address(es)
    ui->payTo_is->setFont(GUIUtil::fixedPitchFont());

    // Connect signals
    connect(ui->payAmount, &FinalcoinAmountField::valueChanged, this, &SendCoinsEntry::payAmountChanged);
