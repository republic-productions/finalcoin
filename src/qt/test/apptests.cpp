...
//! Entry point for FinalcoinApplication tests.
void AppTests::appTests()
{
    ...
    connect(&m_app, &FinalcoinApplication::windowShown, this, &AppTests::guiTests);
...
//! Entry point for FinalcoinGUI tests.
void AppTests::guiTests(FinalcoinGUI* window)
{
    HandleCallback callback{"guiTests", *this};
    connect(window, &FinalcoinGUI::consoleShown, this, &AppTests::consoleTests);
