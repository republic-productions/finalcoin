...
#ifndef FINALCOIN_QT_WALLETVIEW_H
#define FINALCOIN_QT_WALLETVIEW_H
...
private:
    ...
    //!
    //! The wallet model represents a finalcoin wallet, and offers access to
...
#endif // FINALCOIN_QT_WALLETVIEW_H
