...
#ifndef FINALCOIN_QT_GUIUTIL_H
#define FINALCOIN_QT_GUIUTIL_H
...
/** Utility functions used by the Finalcoin Qt UI.
 */
namespace GUIUtil
{
    ...
    // Parse "finalcoin:" URI into recipient object, return true on successful parsing
