...
#ifndef FINALCOIN_INTERFACES_NODE_H
#define FINALCOIN_INTERFACES_NODE_H
...
//! Top-level interface for a finalcoin node (finalcoind process).
class Node
{
public:
    virtual ~Node() {}
...
#endif // FINALCOIN_INTERFACES_NODE_H
