...
#ifndef FINALCOIN_INTERFACES_INIT_H
#define FINALCOIN_INTERFACES_INIT_H
...
//! (finalcoin-gui, finalcoin-node, finalcoin-wallet, finalcoind, finalcoin-qt) and each
...
#endif // FINALCOIN_INTERFACES_INIT_H
