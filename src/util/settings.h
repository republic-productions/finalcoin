...
#ifndef FINALCOIN_UTIL_SETTINGS_H
#define FINALCOIN_UTIL_SETTINGS_H
...
//!       https://github.com/republicproductions/finalcoin/pull/15934/files#r337691812)
...
#endif // FINALCOIN_UTIL_SETTINGS_H
