...
#ifndef FINALCOIN_UTIL_SYSCALL_SANDBOX_H
#define FINALCOIN_UTIL_SYSCALL_SANDBOX_H
...
//!
//! SetupSyscallSandbox(...) is called during finalcoind initialization if Finalcoin Core was compiled
...
#endif // FINALCOIN_UTIL_SYSCALL_SANDBOX_H
