...
#ifndef FINALCOIN_UTIL_MESSAGE_H
#define FINALCOIN_UTIL_MESSAGE_H
 ...
 * @param[in] address Signer's finalcoin address, it must refer to a public key.
...
#endif // FINALCOIN_UTIL_MESSAGE_H
