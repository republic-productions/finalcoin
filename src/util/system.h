 ...
 */
#ifndef FINALCOIN_UTIL_SYSTEM_H
#define FINALCOIN_UTIL_SYSTEM_H
...
extern const char * const FINALCOIN_CONF_FILENAME;
extern const char * const FINALCOIN_SETTINGS_FILENAME;
