...
#ifndef FINALCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
#define FINALCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
...
#endif // FINALCOIN_SUPPORT_ALLOCATORS_ZEROAFTERFREE_H
