...
#ifndef FINALCOIN_SCRIPT_STANDARD_H
#define FINALCOIN_SCRIPT_STANDARD_H
 ...
 *  A CTxDestination is the internal data type encoded in a finalcoin address
 */
...
/**
 * Generate a Finalcoin scriptPubKey for the given CTxDestination. Returns a P2PKH
...
#endif // FINALCOIN_SCRIPT_STANDARD_H
