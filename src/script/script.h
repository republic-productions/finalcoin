...
#ifndef FINALCOIN_SCRIPT_SCRIPT_H
#define FINALCOIN_SCRIPT_SCRIPT_H
...
public:
    ...
    /**
     * Pre-version-0.6, Finalcoin always counted CHECKMULTISIGs
...
#endif // FINALCOIN_SCRIPT_SCRIPT_H
