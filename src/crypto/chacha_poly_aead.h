...
#ifndef FINALCOIN_CRYPTO_CHACHA_POLY_AEAD_H
#define FINALCOIN_CRYPTO_CHACHA_POLY_AEAD_H
...
/* A AEAD class for ChaCha20-Poly1305@finalcoin.
 *
 ...
 *
 * The chacha20-poly1305@finalcoin combines these two primitives into an
 ...
 *
 * The chacha20-poly1305@finalcoin cipher requires two 256 bits of key material as
 ...
 * on the send channel.
 *
 * Optimized implementations of ChaCha20-Poly1305@finalcoin are relatively fast in
...
#endif // FINALCOIN_CRYPTO_CHACHA_POLY_AEAD_H
