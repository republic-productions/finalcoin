...
(define* (make-finalcoin-cross-toolchain target
                                       #:key
...
desirable for building Finalcoin Core release binaries."
...
(define glibc-2.27/finalcoin-patched
    ...
    (cond ((string-suffix? "-mingw32" target)
          ...
          ((string-contains target "-linux-")
           (list (cond ((string-contains target "riscv64-")
                        (make-finalcoin-cross-toolchain target
                                                      #:base-libc glibc-2.27/finalcoin-patched
