#!/bin/sh
# Copyright (c) 2017-2019 The Finalcoin Core developers
...
if [ -z "${1}" ]; then
  ...
  echo "This is probably \`pwd\` if you're at the root of the finalcoin repository."
  exit 1
fi
...
# See https://github.com/republicproductions/finalcoin/issues/16064
...
echo 'When compiling finalcoind, run `./configure` in the following way:'
echo
