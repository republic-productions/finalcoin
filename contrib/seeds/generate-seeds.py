...
def main():
    ...
    g = sys.stdout
    indir = sys.argv[1]
    g.write('#ifndef FINALCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('#define FINALCOIN_CHAINPARAMSSEEDS_H\n')
    g.write('/**\n')
    g.write(' * List of fixed seed nodes for the finalcoin network\n')
    ...
    g.write('#endif // FINALCOIN_CHAINPARAMSSEEDS_H\n')
