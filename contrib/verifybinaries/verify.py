...
"""Script for verifying Finalcoin Core release binaries

This script attempts to download the signature file SHA256SUMS.asc from
finalcoincore.org and finalcoin.org and compares them.
...
WORKINGDIR = "/tmp/finalcoin_verify_binaries"
HASHFILE = "hashes.tmp"
HOST1 = "https://finalcoincore.org"
HOST2 = "https://finalcoin.org"
VERSIONPREFIX = "finalcoin-core-"
...
def main(args):
    ...
    if not success:
        print("finalcoin.org failed to provide signature file, "
              "but finalcoincore.org did?")
        print("wget output:")
        print(indent(output, '\t'))
    ...
    if not files_are_equal(sigfile1, sigfile2):
        print("finalcoin.org and finalcoincore.org signature files were not equal?")
    ...
    if retval != 0:
        if retval == 1:
            ...
            print("gpg error. Do you have the Finalcoin Core binary release "
