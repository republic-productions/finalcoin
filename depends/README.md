...
**Finalcoin Core's `configure` script by default will ignore the depends output.** In
...
RISC-V known issue: gcc-7.3.0 and gcc-7.3.1 result in a broken `test_finalcoin` executable (see https://github.com/republicproductions/finalcoin/pull/13543),
...
options will be passed to finalcoin's configure. In this case, `--disable-wallet`.
