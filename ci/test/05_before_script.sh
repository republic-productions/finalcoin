...
if [ "$CI_OS_NAME" == "macos" ]; then
  echo > $HOME/Library/Application\ Support/Finalcoin
else
  DOCKER_EXEC echo \> \$HOME/.finalcoin
fi
...
if [[ ${USE_MEMORY_SANITIZER} == "true" ]]; then
  ...
  # from depends. See https://github.com/republicproductions/finalcoin/pull/18288#discussion_r433189350 for
  # details.
