...
This document provides guidelines for internationalization of the Finalcoin Core software.
...
This can be checked by executing `make translate` in the `src` directory, then verifying that `finalcoin_en.ts` remains unchanged.
