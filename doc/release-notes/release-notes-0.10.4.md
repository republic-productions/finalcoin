Finalcoin Core version 0.10.4 is now available from:

  <https://finalcoin.org/bin/finalcoin-core-0.10.4/>
...
- #6953 `43c2789` Split finalcoin-tx into its own package
- #6953 `dfe0d4d` Include finalcoin-tx binary on Debian/Ubuntu
