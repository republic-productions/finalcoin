Finalcoin-Qt version 0.8.0 is now available from:
  http://sourceforge.net/projects/finalcoin/files/Finalcoin/finalcoin-0.8.0/
...
Mac and Windows binaries are signed with certificates owned by the Finalcoin
...
New/changed settings (command-line or finalcoin.conf file)
--------------------------------------------------------
