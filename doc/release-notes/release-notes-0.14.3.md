Finalcoin Core version *0.14.3* is now available from:

  <https://finalcoin.org/bin/finalcoin-core-0.14.3/>
...
- #10451 `3612219` contrib/init/finalcoind.openrcconf: Don't disable wallet by default (Luke Dashjr)
