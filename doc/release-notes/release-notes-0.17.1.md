...
When finalcoin is configured with the `-deprecatedrpc=accounts` setting, specifying
...
- #14698 `ec71f06` Add finalcoin-tx.exe into Windows installer (ken2812221)
