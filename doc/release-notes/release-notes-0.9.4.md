Finalcoin Core version 0.9.4 is now available from:

  https://finalcoin.org/bin/0.9.4/
...
this update is incompatible with the Finalcoin system and could lead to consensus
forks.

Finalcoin Core released binaries from https://finalcoin.org are unaffected,
as are any built with the gitian deterministic build system.

However, if you are running either

- The Ubuntu PPA from https://launchpad.net/~finalcoin/+archive/ubuntu/finalcoin
- A third-party or self-compiled Finalcoin Core

upgrade to Finalcoin Core 0.9.4, which includes a workaround, **before** updating
OpenSSL.
