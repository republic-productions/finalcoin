Finalcoin Core version 0.13.2 is now available from:

  <https://finalcoin.org/bin/finalcoin-core-0.13.2/>
...
- #8908 `4a974b2` Update finalcoin-qt.desktop (s-matthew-english)
...
- #8932 `106da69` Allow finalcoin-tx to create v2 transactions (btcdrak)
