...
Finalcoin Core version 0.19.1 is now available from:

  <https://finalcoincore.org/bin/finalcoin-core-0.19.1/>
...
From Finalcoin Core 0.17.0 onwards, macOS versions earlier than 10.10 are no
longer supported, as Finalcoin Core is now built using Qt 5.9.x which requires
macOS 10.10+. Additionally, Finalcoin Core does not yet change appearance when
...
- #17488 fix "finalcoind already running" warnings on macOS (fanquake)
