Finalcoin Core version 0.16.1 is now available from:

  <https://finalcoincore.org/bin/finalcoin-core-0.16.1/>
...
- #12843 `df38b13` Test starting finalcoind with -h and -version (jnewbery)
...
- #12904 `6c26df0` Ensure finalcoind processes are cleaned up when tests end (sdaftuar)
