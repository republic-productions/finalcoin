Finalcoin Core version 0.16.3 is now available from:

  <https://finalcoincore.org/bin/finalcoin-core-0.16.3/>
...
been discovered in Finalcoin Core versions 0.14.0 up to 0.16.2. It is recommended
...
### Miscellaneous
- #13655 `1cdbea7` finalcoinconsensus: invalid flags error should be set to `finalcoinconsensus_err` (afk11)
