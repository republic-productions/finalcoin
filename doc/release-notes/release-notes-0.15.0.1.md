Finalcoin Core version *0.15.0.1* is now available from:

  <https://finalcoin.org/bin/finalcoin-core-0.15.0.1/>

and

  <https://finalcoincore.org/bin/finalcoin-core-0.15.0.1/>
